...
import penelData from "./data/panelData"
...
//console.log(penelData) // log the panelData
//console.log(linkData) // log the linkData
// console.log(constants) // log the constants
...
function makePanel({title, content}) {
  ...
  */
  ...
  panelButtons.addEventListener("click", () => {
    /**
     * 1.) hide open button => 2nd click show the open button
